...
INSERT INTO account_details (user_id, account_type, opened, creditor, credit_limit, credit_use, current_status, collection, collection_agency, amount_paid_to_collection) VALUES 
  (1, 1, '7-29-2010', 'Walmart Credit Card, Synchrony Bank', 4500, 403, 1, 1, '', 0),
  (1, 2, '10-1-2004', 'JP Morgan Chase', 9500, 1290, 1, 1, '', 0),
  (1, 1, '5-12-2001', 'GE Capital Retail Bank', 3200, 203, 1, 1, '', 0),
  (1, 1, '2-27-2011', 'PayPal Platinum MasterCard, Synchrony Bank', 6500, 3490, 1, 1, '', 0),
  (1, 5, '3-25-2009', 'Bank of America', 50000, 9721, 1, 1, '', 0),
  (1, 1, '2-11-2012', 'JetBlue MasterCard, Barclaycard', 4000, 2323, 1, 1, '', 0),
  ...
  (2, 3, '9-22-2009', 'FedLoan Servicing', 4500, 3595, 2, 1, '', 0),
  (2, 1, '2-09-2015', 'JCPenney, Synchrony Bank', 1000, 398, 1, 1, '', 0),
  (2, 1, '4-11-2014', 'Target Credit Card, TD Bank USA', 2300, 292, 1, 1, '', 0),
  (2, 1, '6-23-2015', 'Capital One', 7100, 5232, 2, 2, 'XYZ Collection Agency', 1350),
  (2, 4, '12-17-2016', 'Bank of America', 12000, 8300, 1, 1, '', 0),
  (2, 1, '6-20-2008', 'Best Buy Visa, Cibibank', 2500, 403, 1, 1, '', 0);
